"""
Summary => his class is going to control the processing of images.

Description => This class is going to control the processing of images, within
...
Version =>   0.1 - 12/03/2018 - set up basic set up for the class
             ...
             0.4 - 17/04/2018 - created the methods compress_image to reduce
                        ...
                        this class a parent class. In which stlye processing
...
class ImageProcessor(object):
    ...
    Description => This class is going to control the processing of images,
    ...
    def calculate_coordinates(self, img):
        ...
        return => coordinates => this is a numpy array of coordinates values
        """
