...
"""
@author mah60
@version - 0.1 - created the database manager object. This object will create
                    a connection to the database and be able to manipulate
                    what happens in the database.
                    Such as executing commands and creating, deleting or
                    resetting the required tables. - 01/09/2019;
          - 0.2 - added config file details to connection. - 03/09/2019;
